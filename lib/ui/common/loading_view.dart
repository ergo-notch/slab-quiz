  ...
  void didUpdateWidget(LoadingView oldWidget) {
    ...
    if (oldWidget.status != widget.status) {
      ...
      reverseAnimation().then<TickerFuture>((_) {
        ...
        switch (widget.status) {
          case LoadingStatus.loading:
            result = _loadingController.forward();
            break;
          case LoadingStatus.error:
            result = _errorController.forward();
            break;
          case LoadingStatus.success:
            result = _successController.forward();
            break;
        }
        return result;
      });
  ...
  Widget build(BuildContext context) {
    return Stack(alignment: Alignment.center, children: <Widget>[
      _TransitionAnimation(
          ...
          child: Container(
              alignment: Alignment.center, child: widget.loadingContent),
      ...
      widget.status == LoadingStatus.success
          ? _TransitionAnimation(
              ...
              child: Container(
                  alignment: Alignment.topCenter, child: widget.successContent),
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, _) {
          return IgnorePointer(
              ...
              child: Transform(
                  transform:
                      Matrix4.translationValues(0.0, _yTranslation.value, 0.0),
