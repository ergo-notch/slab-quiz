...
class ClientCardsTile extends StatefulWidget {
  ClientCardsTile(this.client, this.viewModel);

  final Client client;
  final ClientsPageViewModel viewModel;

  @override
  ClientCardsTileState createState() {
    return ClientCardsTileState();
  }
}

class ClientCardsTileState extends State<ClientCardsTile> {
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: InkWell(
            onTap: () => widget.viewModel.getVehiclesById(widget.client.id),
            child: Column(
